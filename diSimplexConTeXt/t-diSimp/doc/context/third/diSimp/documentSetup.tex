...
document, before any line containing \type{\usemodule[t-diSimp]}, by using 
...
\doifmodeelse{codeOnly}{
  \directlua{
    thirddata.diSimp.setCodeOnly(true)
  }
} {
  \directlua{
    thirddata.diSimp.setCodeOnly(false)
  }
}
...
\def\showDiSimpMessages{
  \directlua{
    thirddata.diSimp.showDiSimpMessages(true)
  }
}

\def\hideDiSimpMessages{
  \directlua{
    thirddata.diSimp.showDiSimpMessages(false)
  }
}
\stopMkIVCode
...
\startMkIVCode
\def\diSimpRecurseComponent#1#2{
  \directlua{
    thirddata.diSimp.diSimpRecurseComponent('component', '#1', '#2')
  }
}

\def\addDiSimpRecurseDirs#1{
  \directlua{
    thirddata.diSimp.addDiSimpRecurseDirs('#1')
  }
}
\stopMkIVCode
